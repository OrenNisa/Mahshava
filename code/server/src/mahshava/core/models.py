...
class School(models.Model):
    ...
    proccesStartDate = models.DateField

class SchoolProcess(models.Model):
    #id = models.ForeignKey(School, on_delete=models.CASCADE, primary_key=True, related_name='process')
    #stage_in_process = models.CharField(max_length=50)
    #last_activity = models.DateTimeField(max_length=10)
    #task_to_preform = models.CharField(max_length=50)
    #task_due_time = models.DateTField(max_length=10)
    id = models.AutoField(primary_key=True)
